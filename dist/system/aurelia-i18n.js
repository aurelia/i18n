System.register(['aurelia-templating', 'i18next', 'aurelia-pal', 'aurelia-logging', 'aurelia-event-aggregator', 'aurelia-templating-resources', 'aurelia-binding', 'aurelia-metadata', 'aurelia-dependency-injection', 'aurelia-framework'], (function (exports) {
    'use strict';
    var HtmlBehaviorResource, customAttribute, ViewResources, i18next, DOM, PLATFORM, LogManager, EventAggregator, BindingSignaler, SignalBindingBehavior, ValueConverter, bindingBehavior, valueConverter$1, metadata, resolver, valueConverter;
    return {
            ...
            ***************************************************************************** */
                ...
                I18N.prototype.updateValue = function (node, value, params) {
                    ...
                    while (i--) {
                        ...
                        while (j--) {
                            ...
                            switch (attr) {
                                case "text":
                                    var newChild = DOM.createTextNode(translatedResult);
            ...
            var TBindingBehavior = exports('TBindingBehavior', /** @class */ (function () {
                ...
                TBindingBehavior.prototype.bind = function (binding, source) {
                    ...
                    sourceExpression.expression = new ValueConverter(expression, "t", sourceExpression.args, __spreadArray([expression], sourceExpression.args, true));
                };
            ...
            var NfBindingBehavior = exports('NfBindingBehavior', /** @class */ (function () {
                ...
                NfBindingBehavior.prototype.bind = function (binding, source) {
                    ...
                    sourceExpression.rewritten = true;
                    var expression = sourceExpression.expression;
                    sourceExpression.expression = new ValueConverter(expression, "nf", sourceExpression.args, __spreadArray([expression], sourceExpression.args, true));
                };
            ...
            var DfBindingBehavior = exports('DfBindingBehavior', /** @class */ (function () {
                ...
                DfBindingBehavior.prototype.bind = function (binding, source) {
                    ...
                    sourceExpression.rewritten = true;
                    var expression = sourceExpression.expression;
                    sourceExpression.expression = new ValueConverter(expression, "df", sourceExpression.args, __spreadArray([expression], sourceExpression.args, true));
                };
            ...
            var RtBindingBehavior = exports('RtBindingBehavior', /** @class */ (function () {
                ...
                RtBindingBehavior.prototype.bind = function (binding, source) {
                    ...
                    sourceExpression.rewritten = true;
                    var expression = sourceExpression.expression;
                    sourceExpression.expression = new ValueConverter(expression, "rt", sourceExpression.args, __spreadArray([expression], sourceExpression.args, true));
                };
